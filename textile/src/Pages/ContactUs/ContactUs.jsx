...
import iichundrigar from "./iichundrigar.png";
export default function ContactUs(params) {
  ...
  return (
    <>
      ...
      {/* <div className="">
        <img src={iichundrigar} alt="" srcset="" />
      </div> */}
      ...
      <br />
      <br />
      <h1 class="sm:text-5xl text-2xl font-medium title-font mb-2 text-gray-900 text-center">
        Contact Us
      </h1>
